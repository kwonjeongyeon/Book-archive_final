package com.myspring.bookarchive.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.myspring.bookarchive.*.service.*.*(..)) or "
			+ "execution(* com.myspring.bookarchive.*.dao.*.*(..))")
	...
	@After("execution(* com.myspring.bookarchive.*.service.*.*(..)) or "
			+ "execution(* com.myspring.bookarchive.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.myspring.bookarchive.*.service.*.*(..)) or "
			+ "execution(* com.myspring.bookarchive.*.dao.*.*(..))")
