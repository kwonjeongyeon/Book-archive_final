 ...
 <script>
   ...
   window.onload=function()
    ...
    function selectBoxInit(){
     ...
     var tel1='${memberInfo.tel1 }'; //유선전화 국번 저장
     var hp1='${memberInfo.hp1}';  //휴대전화 국번 저장
     ...
     //유선전화 국번의 셀렉트 박스 값을 tel1값으로 초기화
	...
	<div id="detail_table">
		<table>
			<tbody>
				...
				<tr class="dot_line">
					<td class="fixed_join">전화번호</td> <%-- 유선전화 국번 선택 셀렉트 박스 --%>
					<td>
				...
				<tr class="dot_line">
					<td class="fixed_join">휴대폰번호</td> <%-- 휴대폰 국번 선택 셀렉트 박스 --%>
					<td>
